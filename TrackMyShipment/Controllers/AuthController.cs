...
namespace TrackMyShipment.Controllers
{
    ...
    {
        public AuthController(ObjectiveManage objectiveManage,UserManage userManage, CarrierManage carrierManage,CompanyManage companyManage,SubscriptionManage subscriptionManage)
